package com.zaaach.toprightmenudemo.view;
...
public class ScanView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mShader = new SweepGradient(mSize / 2, mSize / 2, Color.TRANSPARENT, Color.GREEN);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(mSize/2, mSize/2, mRadius/2+60, mCirclePaint);
        canvas.drawCircle(mSize/2, mSize/2, mRadius-20, mCirclePaint);
        //画十字线
        //竖线
